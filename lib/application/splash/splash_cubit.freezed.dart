...
class _$SplashStateTearOff {
  ...
  _SplashState call({required bool splash}) {
    return _SplashState(
      splash: splash,
    );
  }
...
class _$_SplashState implements _SplashState {
  const _$_SplashState({required this.splash});
  ...
  @override
  String toString() {
    return 'SplashState(splash: $splash)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(splash));
...
abstract class _SplashState implements SplashState {
  const factory _SplashState({required bool splash}) = _$_SplashState;
